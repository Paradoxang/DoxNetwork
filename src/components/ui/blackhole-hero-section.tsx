...
/*                                                                            */
/*  DoxNetwork: copiado tal cual del componente original. Solo se quitó        */
/*  "use client" (Vite no usa React Server Components); los colores y el       */
/*  encuadre de la marca se pasan como props desde sections/Hero.tsx.          */
/* -------------------------------------------------------------------------- */
